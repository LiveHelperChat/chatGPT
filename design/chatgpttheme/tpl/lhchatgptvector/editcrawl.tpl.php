...
$modalHeaderTitle = erTranslationClassLhTranslation::getInstance()->getTranslation('chat/chatpreview','Edit Crawler');
$modalSize = 'xl';
$modalBodyClass = 'p-1'
?>
...
<?php include(erLhcoreClassDesign::designtpl('lhkernel/modal_header.tpl.php'));?>
    ...
    <div class="modal-body lhc-module">
        ...
        <form action="<?php echo erLhcoreClassDesign::baseurl('chatgptvector/editcrawl')?>/<?php echo htmlspecialchars($storage_id)?>/<?php echo $item->id?>" method="post" onsubmit="return lhinst.submitModalForm($(this))">
