...
<div class="form-group">
    <ul class="nav nav-tabs" role="tablist">
        ...
        <?php endif; ?>
        <li class="nav-item">
            <a class="nav-link <?php echo (erLhcoreClassModule::getExtensionInstance('erLhcoreClassExtensionChatgpt')->settings['crawler'] === false || (isset($item->type) && $item->type == \LiveHelperChatExtension\chatgpt\providers\erLhcoreClassModelChatGPTCrawl::TYPE_CONTENT)) ? 'active' : ''; ?>" href="#content-tab" data-bs-toggle="tab" role="tab">
...
<div class="tab-content">
    ...
    <div class="tab-pane fade <?php echo (erLhcoreClassModule::getExtensionInstance('erLhcoreClassExtensionChatgpt')->settings['crawler'] === false || (isset($item->type) && $item->type == \LiveHelperChatExtension\chatgpt\providers\erLhcoreClassModelChatGPTCrawl::TYPE_CONTENT)) ? 'show active' : ''; ?>" id="content-tab" role="tabpanel">
        <div class="form-group">
