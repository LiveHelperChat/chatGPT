...
\LiveHelperChatExtension\chatgpt\providers\ChatGPTLiveHelperChatVectorStorage::deleteFileFromVectorStorage($Params['user_parameters']['vector_storage_id'], $Params['user_parameters']['file_id']);
